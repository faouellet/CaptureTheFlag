        ...
        for bot in self.game.bots_available:
            ...
            # In this case, the flag has not been captured yet so have this bot attack it!
                ...
                if random.choice([True, False]):
                    self.issue(commands.Attack, bot, path, description = 'attacking enemy flag', lookAt = random.choice([their_flag, our_flag, their_flag, their_base]))
                else:
                    self.issue(commands.Charge, bot, path, description = 'charging enemy flag')
